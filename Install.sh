...
source <(wget -qO- https://raw.githubusercontent.com/bbilyvm/Seedbox-Components/main/Miscellaneous/tput.sh)
...
source <(wget -qO- https://raw.githubusercontent.com/bbilyvm/Seedbox-Components/main/seedbox_installation.sh)
Update
Decision qBittorrent
echo "Skipping Deluge installation."
echo "Skipping autoremove-torrents installation."


## Tweaking
tput sgr0; clear
normal_1; echo "Start Doing System Tweak"; warn_2
source <(wget -qO- https://raw.githubusercontent.com/bbilyvm/Seedbox-Components/main/tweaking.sh)
CPU_Tweaking
NIC_Tweaking
...
kernel_Tweaking
echo "Installing Tweaked_BBR..."
Tweaked_BBR

## Configue Boot Script
tput sgr0; clear
normal_1; echo "Start Configuing Boot Script"
source <(wget -qO- https://raw.githubusercontent.com/bbilyvm/Seedbox-Components/main/Miscellaneous/boot-script.sh)
boot_script
tput sgr0; clear
